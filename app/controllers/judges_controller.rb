class JudgesController < ApplicationController
  ...
  def show
    ...
    if judgepreference.preference == "All"
        ...
        @videolist = Video.getrandomvideos(noofvideos,"Category",preferredcategories)
    elsif judgepreference.preference == "Contestant"
        studentids = JudgeContestant.getContestant(params[:id])
        @videolist = Video.getrandomvideos(noofvideos,"Contestant",studentids)        
    end
